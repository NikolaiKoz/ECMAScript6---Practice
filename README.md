...
Los rest parameters son parametros que se pueden utilizar para asignar un valor por defecto a los parametros de una funcion, y se pueden utilizar para interpolar variables.
